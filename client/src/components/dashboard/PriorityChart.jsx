...
const PriorityChart = () => {
  ...
  const priorityData = [
    {
      name: "Critical",
      count: dashboardData?.highPriorityIssues || 0,
      value: getPercentage(dashboardData?.highPriorityIssues || 0),
      color: "#f97316",
...
// const priorityData = [
//   { name: "Critical", value: 25, color: "#f97316" },
//   { name: "Standard", value: 60, color: "#111827" },
//   { name: "Routine", value: 10, color: "#fb923c" },
...
//         <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
//           <h3 className="text-2xl font-extrabold text-black">1.2k</h3>
